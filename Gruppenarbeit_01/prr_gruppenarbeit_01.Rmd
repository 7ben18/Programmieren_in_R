...
Folgende Libraries müssen installiert und geladen werden:
```{r}
library(ISLR2)
library(tidyverse)
```
In der Library ISLR2 befindet sich der Datensatz und Tidyverse wird für die Darstellung des Datensatzes und Visualisierungen benötigt.
...
Der Datensatz enthält keine fehlende Werte. Die Aufbereitung der Daten entfällt deshalb.


### Histogramm der Verkäufe
