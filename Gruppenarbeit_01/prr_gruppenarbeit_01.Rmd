...
tail(Carseats)
```
Durch die Ausgabe von Kopfzeile und Fusszeile kommen wir mit dem Datensatz in Berührung und koennen ein Bild der Attribute sowie Observationen machen.
...
# Hypothese 1: Einfache lineare Regression
Sales ist abhängig von Income/Advertising/Population der Region.
...
Bevor wir mit der Linearen Regression beginnen, erstellen wir zuerst ein Streudiagramm von beiden Variabeln, um die Zusammenhaenge zu visualiseren. Hier erkennen wir im Plot, dass die Variabeln Einkommen und Sales nicht besonders stark korrelieren, da die Punkte ueberall im Plot verstreut sind. 
...
Die Differenz von Comprice und Price hat einen Einfluss auf den Verkauf.
...
Sales lässt sich durch die Verwendung von mehreren Features zuverlässiger vorhersagen.
